...
\configClass{loop:commandOutput}{loopType:commandOutput} from the global section.
The \config{command}='\verb|ls -1 download|' (or '\verb|dir /b download|' for Windows)
lists the content of the download directory and assigns each file name to the
\config{variableLoopString}=\verb|loopFile|.
