/***********************************************/
/**
* @file gnssParametrizationTransmitterBeidou.cpp
*
...
GnssParametrizationTransmitterBeidou::GnssParametrizationTransmitterBeidou(Config &config)
{
  try
  {
    ...
    readConfig(config, "inputfileTransmitterList",      fileNameTransmitterList,       Config::MUSTSET,  "{groopsDataDir}/gnss/transmitterBeidou/transmitterList.beidou.txt", "ascii file with transmitter PRNs, used to loop variable {prn}");
    readConfig(config, "inputfileTransmitterInfo",      fileNameTransmitterInfo,       Config::MUSTSET,  "{groopsDataDir}/gnss/transmitterBeidou/transmitterInfo/igs/igs14/transmitterInfo_igs14.{prn}.xml", "variable {prn} available");
    readConfig(config, "inputfileAntennaDefintion",     fileNameAntennaDef,            Config::MUSTSET,  "{groopsDataDir}/gnss/transmitterBeidou/antennaDefinition/igs/igs14/antennaDefinition_igs14.xml", "phase centers and variations (ANTEX)");
    readConfig(config, "inputfileReceiverDefintion",    fileNameReceiverDef,           Config::OPTIONAL, "{groopsDataDir}/gnss/transmitterBeidou/receiverDefinition/receiverDefinition.xml", "transmitted signal types");
