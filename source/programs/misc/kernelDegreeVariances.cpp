/***********************************************/
/**
* @file kernelDegreeVariances.cpp
*
...
class KernelDegreeVariances
{
public:
  void run(Config &config);
};

GROOPS_REGISTER_PROGRAM(KernelDegreeVariances, SINGLEPROCESS, "Kernel/Covariance-function from gravity field accuracies, if not given from signal (cnm,snm), if not given from kaulas rule", Misc)

/***********************************************/

void KernelDegreeVariances::run(Config &config)
{
  try
  {
