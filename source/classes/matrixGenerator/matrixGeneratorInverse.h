...
inline MatrixGeneratorInverse::MatrixGeneratorInverse(Config &config) : MatrixGeneratorBase(config)
{
  try
  {
...
inline void MatrixGeneratorInverse::compute(Matrix &A, UInt &/*startRow*/, UInt &/*startCol*/)
{
  try
  {
    A = matrix->compute();
