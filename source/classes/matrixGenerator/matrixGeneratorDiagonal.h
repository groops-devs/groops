...
inline MatrixGeneratorDiagonal::MatrixGeneratorDiagonal(Config &config) : MatrixGeneratorBase(config)
{
  try
  {
...
inline void MatrixGeneratorDiagonal::compute(Matrix &A, UInt &/*startRow*/, UInt &/*startCol*/)
{
  try
  {
    A = matrix->compute();
